    ...
    **/
    {
      ...
      **/
      ...
      // source maps in dev. Production uses the plugin below, mostly to give us a bit more control
      // (sometimes we want to exclude a huge bit of third party or pre-compiled js for example)
